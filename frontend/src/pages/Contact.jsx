      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="rounded-2xl bg-slate-900 border border-white/5 p-6 shadow-soft">
            ...
            <div className="w-full h-56 bg-slate-800 rounded-xl border border-white/10 flex items-center justify-center text-slate-400 text-sm">
          ...
          <div className="grid grid-cols-3 gap-3 text-sm">
            ...
            <a href="mailto:colettenshimyumuremyi@gmail.com" className="flex flex-col items-center gap-2 rounded-xl bg-blue-500/15 border border-blue-400/30 p-4 text-blue-100 hover:-translate-y-0.5 transition">
              <Mail />
              Email
            </a>
